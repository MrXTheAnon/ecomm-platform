...
A production-grade data engineering pipeline that simulates an e-commerce company collecting **~2.8TB/day** of multi-modal data. Built with Apache Kafka, PySpark, MongoDB, PostgreSQL, and MinIO — fully containerised with Docker Compose and visualised through a live-updating Streamlit dashboard.
...
```bash
git clone https://github.com/<your-username>/ecomm-platform.git
cd ecomm-platform
...
| pgAdmin | http://localhost:5050 | admin@ecomm.local / admin |
