# dashboard/app.py — E-Comm Data Platform Dashboard
import sys
import time
...
st.set_page_config(
    page_title="E-Comm Data Platform",
    page_icon="🛒",
    layout="wide",
...
def get_mongo_col():
    ...
    try:
        ...
        client = MongoClient(
            "mongodb://admin:ecomm_mongo_pass@localhost:27017/",
            serverSelectionTimeoutMS=2000,
            connectTimeoutMS=2000,
        )
        client.admin.command("ping")   # verify connection is live
        return client["ecomm_cvs"]["customer_profiles"]
    except Exception:
        return None
